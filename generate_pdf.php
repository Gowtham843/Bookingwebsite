...
.container1 h3 {
  ...
  text-transform: uppercase;
    ...
    <div class='date_time_con' style='margin-top:10px;text-align:center;'>
    ...
    <div class='receipt_body'>
        ...
        <div class='items'>
            <table class='table1'> 
                ...
                <tbody class='tbody1'>
                    <tr>
                        <td style='text-align:center;'>Room Name: $data[room_name]</td>
                        <td style='text-align:center;'>Cost: ₹$data[price] per night</td>
                    </tr>
                </tbody>
                </table>
                ...
                <tfoot class='tfoot1'>
                    <tr>
                        ...
                        <td style='text-align:center;'>₹$data[total_pay]</td>
                    </tr>
