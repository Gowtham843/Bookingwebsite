...
<head>
    ...
    <title>Admin Panel -UserData</title>
    <?php
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                <h3 class="mb-4">User Contact Data</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md" style="height: 500px; overflow-y:scroll;">
                            <table class="table table-hover border">
                                ...
                                <tbody>
                                   <?php 
                                   $q="Select * from `user_contact_us` order by `sr_no` desc";
                                   ...
                                   while ($row=mysqli_fetch_assoc($data)) {
                                    ...
                                    $seen.="<a href='?delete=$row[sr_no]' class='btn btn-sm  btn-danger mx-2 mt-2'><i class='bi bi-trash'></i></a>";
                                    echo<<<data
                                    <tr>
                                        <td>$i</td>
                                        <td>{$row['name']}</td>
